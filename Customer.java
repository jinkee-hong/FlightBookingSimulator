...
public class Customer{
    ...
    private HashMap<String,Integer[][]> seatPlace = new HashMap<>(); // store where to sit according to their name(or status)
    ...
    // 1 - Number of adults
    // 2 - Number of kids
    Customer(Vector<String> customer_info,HashMap<String,Integer> seatRelation,HashMap<String,Integer[][]>seatPlace ) {
